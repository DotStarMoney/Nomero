...
type ObjectValueSet
    public:
        declare constructor()
        declare destructor()
        declare sub _addValue_(ID_ as string, value_ as _Item_valueContainer_t ptr, geom as Shape2D ptr)
        ...
        declare sub getGeometry(byref geom_ as Shape2D ptr, i as integer)
